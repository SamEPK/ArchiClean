      ...
      <div className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-40">
        <div className="container-bank mx-auto px-4">
           <div className="flex gap-1 overflow-x-auto">
              <NavLink href={`/${locale}/dashboard/client`} active={pathname?.includes('/client')}>
                 <Briefcase size={18} />
                 <span>Ma Synthèse</span>
              </NavLink>
              <NavLink href={`/${locale}/dashboard/client/accounts`} active={pathname?.includes('/accounts')}>
                 <PieChart size={18} />
                 <span>Mes Comptes</span>
              </NavLink>
              <NavLink href={`/${locale}/dashboard/client/profile`} active={pathname?.includes('/profile')}>
                 <Settings size={18} />
